      ...
      <div class="grid w-full max-w-5xl gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        <section class="rounded-[2rem] border border-white/10 bg-slate-900/90 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur-xl sm:p-10">
          <div>
            ...
            <h1 class="mt-3 text-2xl font-semibold text-white">Register</h1>
            <p class="mt-2 text-sm text-slate-400">Start managing the distributed storage system in a few seconds.</p>
          </div>
        ...
        <section class="rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-900 via-slate-950 to-cyan-500/10 p-8 shadow-2xl shadow-cyan-950/20 sm:p-10">
          <p class="text-sm uppercase tracking-[0.34em] text-cyan-300/80">Why this UI</p>
          <h2 class="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
            Designed for reliable file operations, not demo-only screens.
          </h2>
          <div class="mt-8 space-y-4">
            <div class="rounded-3xl border border-white/10 bg-white/5 p-5">
              <p class="text-sm font-semibold text-white">Retry-safe workflows</p>
              <p class="mt-2 text-sm text-slate-400">Idempotency keys stay visible and reusable for uploads and session-based flows.</p>
            </div>
            <div class="rounded-3xl border border-white/10 bg-white/5 p-5">
              <p class="text-sm font-semibold text-white">Admin-aware navigation</p>
              <p class="mt-2 text-sm text-slate-400">Worker actions are guarded in both routing and presentation so non-admins never land in privileged tools.</p>
            </div>
            <div class="rounded-3xl border border-white/10 bg-white/5 p-5">
              <p class="text-sm font-semibold text-white">Deep file visibility</p>
              <p class="mt-2 text-sm text-slate-400">Browse manifests, version history, health, and storage worker outcomes with clear timestamps and status feedback.</p>
            </div>
          </div>
        </section>
      </div>
